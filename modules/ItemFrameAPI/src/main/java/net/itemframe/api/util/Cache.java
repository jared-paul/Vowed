...
public class Cache {
    ...
    /* net.itemframe.api.utilitemframe.api.Cache Creating */
    ...
    /* net.itemframe.api.Cacheame.api.util.Cache Multiframe Creating */
    ...
    /* net.itemframe.api.Cacheame.api.util.Cache Getting */
