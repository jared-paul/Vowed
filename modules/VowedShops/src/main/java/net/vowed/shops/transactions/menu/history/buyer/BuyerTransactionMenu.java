 ...
 */
public class BuyerTransactionMenu extends MultiMenu
{
    public BuyerTransactionMenu(UUID uuid, int pages)
    {
        super(54, ChatColor.YELLOW + "Buying Transactions", pages);
                                                      ...
                                                      new SQLStorage.Callback<ResultSet>()
                                                 {
                                                     ...
                                                     public void onSuccess(ResultSet resultSet) throws SQLException
                                                     {
                                                         ...
                                                         while (resultSet.next())
                                                         {
                                                             ...
                                                             {
                                                                 addItem(slot, new BuyerMenuItem(), transaction);
                                                             }
