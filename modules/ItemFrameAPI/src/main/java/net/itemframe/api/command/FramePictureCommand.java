package net.itemframe.api.command;

import net.itemframe.api.FrameManager;
import net.itemframe.api.FramePicturePlugin;
import net.itemframe.api.util.Cache;
import net.itemframe.api.util.Config;
...
public class FramePictureCommand implements CommandExecutor {
    ...
    public boolean sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("/FramePicture set <URL>  " + ChatColor.GOLD + "--" + ChatColor.WHITE + "  Set a Picture in a net.itemframe.api.utilitemframe.api.Frame.");
        ...
        sender.sendMessage("/FramePicture reload  " + ChatColor.GOLD + "--" + ChatColor.WHITE + "  Reload the net.itemframe.api.Configme.api.util.Config.");
        return true;
    }
