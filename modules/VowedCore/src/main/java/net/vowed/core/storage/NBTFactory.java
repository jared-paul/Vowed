...
public class NBTFactory {
    ...
    /**
     * Set the NBT compound tag of a given generalGUI stack.
     * <p>
     * The generalGUI stack must be a wrapper for a CraftItemStack. Use
     * @param stack - the generalGUI stack, cannot be air.
    ...
    /**
     * Construct a wrapper for an NBT tag stored (in memory) in an generalGUI stack. This is where
     * auxillary data such as enchanting, name and lore is stored. It does not include net.vowed.core.items
     * material, damage value or count.
     * <p>
     * The generalGUI stack must be a wrapper for a CraftItemStack.
     * @param stack - the generalGUI stack.
